                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <!-- <label for="title" class="col-md-12 col-form-label">{{ __('Article Title') }}</label> -->
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Article Title" value="{{ $article->title }}" required autocomplete="title">
